...
export const navMain = 'h-full flex items-center justify-between md:hidden'
...
export const navMenuLeft = 'w-1/3'
export const navMenuRight = 'w-2/3 flex items-center justify-between gap-8'
export const searchBar =
  'flex items-center justify-between gap-4 bg-gray-100 p-2 rounded-md flex-1'
export const searchBarInput = 'flex-1 outline-none'
